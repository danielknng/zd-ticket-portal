...
import { TIMING_CONSTANTS, CURRENT_YEAR } from './constants.js';
...
const NF_CONFIG = {
     ...
     * @property {boolean} allowRequestType - Whether to allow the user to pick the request type of their ticket
     */
    api: {
    ...
    system: {
        ...
        assets: {
            triggerButtonImage: '../../public/img/it-service_portal.png',  // Relative to HTML file location (src/html/)
