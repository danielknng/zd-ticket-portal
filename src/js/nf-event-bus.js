...
const nfEventBus = new NFEventBus();

// Make available globally for backward compatibility and convenience
if (typeof window !== 'undefined') {
    window.nfEventBus = nfEventBus;
}

export default nfEventBus;
export { NFEventBus };
